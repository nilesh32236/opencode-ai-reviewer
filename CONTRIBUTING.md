...
> **Upgrading from Node 20/22?** Install the LTS floor with `nvm install 24.21.0 && nvm use 24.21.0`
> (or `nvs add 24.21.0` / `nvs use 24.21.0`). During the grace period a below-floor
