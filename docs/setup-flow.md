...
| 3 | **OpenCode CLI** | `opencode` resolves on PATH (or is auto-installed) and reports version `>= 1.1.1` (minimum; tested: `1.18.31`, warn below `1.15.0`; pinned checksums: `docs/opencode-checksums.md`) | `OpenCode CLI v1.0.0 is below the minimum supported version v1.1.1` |
