...
| 3 | **OpenCode CLI** | `opencode` resolves on PATH (or is auto-installed) and reports version `>= 1.1.1` (hard floor); versions below `1.15.0` log an upgrade warning, tested/pinned version is `1.18.31` (pinned checksums: `docs/opencode-checksums.md`; CLI docs: `https://opencode.ai/docs/cli`, releases: `https://github.com/sst/opencode/releases`) | `OpenCode CLI v1.0.0 is below the minimum supported version v1.1.1` |
