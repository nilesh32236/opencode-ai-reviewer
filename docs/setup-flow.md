...
| 3 | **OpenCode CLI** | `opencode` resolves on PATH (or is auto-installed) and reports version `>= 1.1.1` (pinned checksums: `docs/opencode-checksums.md`) | `OpenCode CLI v1.0.0 is below the minimum supported version v1.1.1` |
